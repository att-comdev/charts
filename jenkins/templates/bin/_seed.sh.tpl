...
mv -v /seed/cicdfolderconfig.xml /var/jenkins_home/jobs/CICD/config.xml
mv -v /seed/superseedconfig.xml /var/jenkins_home/jobs/CICD/jobs/SuperSeed/config.xml
