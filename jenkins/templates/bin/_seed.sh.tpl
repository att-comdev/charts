...
# known_hosts file doesnt exists or if it exists and the size is 0 create one from global_env_vars
...
{{ else }}
# known_hosts file doesnt exists or if it exists and the size is 0 create one from content
