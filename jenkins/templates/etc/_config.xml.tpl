    ...
    <hudson.slaves.EnvironmentVariablesNodeProperty>
      <envVars serialization="custom">
        ...
        <tree-map>
          ...
          <string>{{ .Values.conf.config.jenkins.keystone.url }}</string>
          <string>OS_KEYSTONE_IMAGE</string>
          <string>{{ .Values.conf.config.jenkins.keystone.image }}</string>
          <string>OS_PROJECT_NAME</string>
          <string>jenkins</string>
          <string>OS_REGION_NAME</string>
          <string>{{ .Values.conf.config.jenkins.region }}</string>
