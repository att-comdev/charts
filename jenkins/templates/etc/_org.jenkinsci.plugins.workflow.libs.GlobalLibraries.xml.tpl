        ...
        <scm class="hudson.plugins.git.GitSCM" plugin="git@3.8.0">
          ...
          <branches>
            <hudson.plugins.git.BranchSpec>
              <name>&dollar;&lbrace;library.{{ .Values.conf.global_libraries.libraries.upstream_lib.name }}.version&rbrace;</name>
            </hudson.plugins.git.BranchSpec>
          </branches>
      ...
      <org.jenkinsci.plugins.workflow.libs.LibraryConfiguration>
        ...
        <retriever class="org.jenkinsci.plugins.workflow.libs.SCMRetriever">
          <scm class="hudson.plugins.git.GitSCM" plugin="git@3.8.0">
            ...
            <branches>
              <hudson.plugins.git.BranchSpec>
                <name>&dollar;&lbrace;library.{{ .Values.conf.global_libraries.libraries.internal_lib.name }}.version&rbrace;</name>
              </hudson.plugins.git.BranchSpec>
            </branches>
            <doGenerateSubmoduleConfigurations>false</doGenerateSubmoduleConfigurations>
            <submoduleCfg class="list"/>
