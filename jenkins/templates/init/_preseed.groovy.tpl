...
if(Jenkins.instance.getAllItems(hudson.model.Job).size() == 0) {
    ...
    def hasher = org.jenkinsci.plugins.scriptsecurity.scripts.ScriptApproval.DEFAULT_HASHER
    scriptApproval.approveScript(hasher.hash(new File('/tmp/cicd', jenkinsFile).text, 'groovy'))
