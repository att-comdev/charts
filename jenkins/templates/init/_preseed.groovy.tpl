...
if(Jenkins.instance.getAllItems(hudson.model.Job).size() == 0) {
    ...
    if (jobsList) {
        ...
        // first run will fail but add superseed script to the approval queue (2 min timeout)
        createdJob.scheduleBuild2(0, new ParametersAction(params)).get(2, TimeUnit.MINUTES)
